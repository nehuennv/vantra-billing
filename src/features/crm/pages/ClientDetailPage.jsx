                ...
                if (clientData) {
                    ...
                    try {
                        ...
                        const adaptedServices = rawServices.map(s => ({
                            ...
                            iva_percentage: s.iva_percentage != null ? Number(s.iva_percentage) : 21,
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {client.is_active ? (
                            ...
                            <Button
                                ...
                                className="h-9 border-primary/30 text-primary hover:bg-primary/10 hover:text-primary hover:border-primary/40 shadow-sm"
                            ...
                            <div className="divide-y divide-slate-100">
                                ...
                                <div className="p-4 hover:bg-slate-50/30 transition-colors bg-white">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {client.whatsapp && (
                                            <a href={`https://wa.me/${client.whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-primary hover:text-primary/80 hover:underline group">
                                                <div className="bg-primary/15 p-0.5 rounded-full">
                                                    ...
                                                    <td className="px-6 py-3 text-center">
                                                        {inv.status === 'pending' || inv.status === 'EMITTED' || inv.status === 'SENT' ? (
                                                            <Button
                                                                ...
                                                                className="h-7 px-2 text-primary hover:text-primary/80 hover:bg-primary/10 text-xs font-semibold"
                                                            >
